...
if ( factoryResultKasteel1.IsSuccess && factoryResultKasteel2.IsSuccess )
{
    ...
    kasteel1.VoegBewonerToe(new Prinses("Pocahontas", "Houdt van bruin"));

    kasteel1.VoegBewonerToe(new Ridder("Lancelot", 200));
    kasteel1.VoegBewonerToe(new Ridder("Lance", 150));

    kasteel1.VoegBewonerToe(new Kok("Gordon", "Spaghetti"));

    kasteel1.VoegBewonerToe(new Stalknecht("Jef"));
...
{
    Console.Write($"De kastelen zijn niet goed: " + factoryResultKasteel1.ErrorMessages + factoryResultKasteel2.ErrorMessages);
}
